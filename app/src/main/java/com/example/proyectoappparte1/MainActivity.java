...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_avatar3 = (ImageButton) findViewById(R.id.btn_avatar5);
        btn_avatar4 = (ImageButton) findViewById(R.id.btn_avatar6);
        btn_avatar5 = (ImageButton) findViewById(R.id.btn_avatar4);
        btn_avatar6 = (ImageButton) findViewById(R.id.btn_avatar3);
